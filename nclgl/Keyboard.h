...
public:
	...
	void InitialiseMapper()
	{
		...
		button_mapping.insert({ "B", KEYBOARD_B });
		button_mapping.insert({ "C", KEYBOARD_C });
		button_mapping.insert({ "D", KEYBOARD_D });
		button_mapping.insert({ "E", KEYBOARD_E });
		button_mapping.insert({ "F", KEYBOARD_F });
		button_mapping.insert({ "G", KEYBOARD_G });
		button_mapping.insert({ "H", KEYBOARD_H });
		button_mapping.insert({ "I", KEYBOARD_I });
		button_mapping.insert({ "J", KEYBOARD_J });
		button_mapping.insert({ "K", KEYBOARD_K });
		button_mapping.insert({ "L", KEYBOARD_L });
		button_mapping.insert({ "M", KEYBOARD_M });
		button_mapping.insert({ "N", KEYBOARD_N });
		button_mapping.insert({ "O", KEYBOARD_O });
		button_mapping.insert({ "P", KEYBOARD_P });
		button_mapping.insert({ "Q", KEYBOARD_Q });
		button_mapping.insert({ "R", KEYBOARD_R });
		button_mapping.insert({ "S", KEYBOARD_S });
		button_mapping.insert({ "T", KEYBOARD_T });
		button_mapping.insert({ "U", KEYBOARD_U });
		button_mapping.insert({ "V", KEYBOARD_V });
		button_mapping.insert({ "W", KEYBOARD_W });
